...
-- NOTE: password below is a bcrypt hash of the original demo password "123".
-- CHANGE THIS before deploying anywhere public. To generate a new hash, run
-- in PHP: echo password_hash('your-new-password', PASSWORD_DEFAULT);
INSERT INTO `adminlogin` (`id`, `name`, `password`) VALUES
(1, 'Namrata', '$2b$12$BFmGtYbWGtx7QTA9fYG8J.q342ET.gq4Pk14QgIscaHba6WSyHpRO'),
(2, 'Disha', '$2b$12$BFmGtYbWGtx7QTA9fYG8J.q342ET.gq4Pk14QgIscaHba6WSyHpRO');
